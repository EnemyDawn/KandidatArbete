...
namespace BoidTest
{
    ...
    /// </summary>
    class NewVideoPlayer : ISampleGrabberCB, IDisposable
    {
        ...
        public NewVideoPlayer(string FileName, GraphicsDevice graphicsDevice)
        {
            try
            {
                // Set video state
                ...
                outputFrame = new Texture2D(graphicsDevice, videoWidth, videoHeight, false, SurfaceFormat.Bgr32);
            }
            catch
            {
        ...
        public void Stop()
        {
            ...
            DsError.ThrowExceptionForHR(ms.SetPositions(0, AMSeekingSeekingFlags.AbsolutePositioning, 0, AMSeekingSeekingFlags.AbsolutePositioning));
        ...
        {  
            ...
            // Stop the FilterGraph
            DsError.ThrowExceptionForHR(mc.StopWhenReady());
            
            // Reset the current position
            DsError.ThrowExceptionForHR(ms.SetPositions(0, AMSeekingSeekingFlags.AbsolutePositioning, videoDuration, AMSeekingSeekingFlags.AbsolutePositioning));
